...
if __name__ == "__main__":
    ...
    cols = ['code', 'product_name', 'last_modified_by', 'generic_name', 'packaging', 
            'packaging_text', 'brands', 'categories', 'manufacturing_places', 
    ...
    # It is possible to exclude words
    words_to_exclude= ["NaN", "foods", "based", 'jams', 'desserts', 
                       'fromages', 'boissons']
    ...
    #display_word_cloud_frequencies(freq)